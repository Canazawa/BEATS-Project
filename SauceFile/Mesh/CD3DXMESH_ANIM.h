...
public:
	...
	HRESULT InitDx9();
	HRESULT InitShader();
	void Render(D3DXVECTOR3& pos, D3DXVECTOR3& rot, D3DXVECTOR3& scale);
	...
	void MoveJump(float);
	static void SetCamera(D3DXMATRIX& view, D3DXMATRIX& proj, D3DXVECTOR3& vLight, D3DXVECTOR3& vEye);
};
